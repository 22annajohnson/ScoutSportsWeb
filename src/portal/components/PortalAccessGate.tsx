            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/70">
                  This Phase 1 portal turns the old player preview into a business foundation shell with business
                  settings, team roles, billing visibility, and audit-style activity before ads and analytics arrive.
                </p>
              </div>
