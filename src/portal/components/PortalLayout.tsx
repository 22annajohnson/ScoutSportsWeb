...
const portalNav = [
  ...
  { label: "Business", href: routes.portalBusiness, icon: Building2 },
  { label: "Team", href: routes.portalTeam, icon: Users2 },
  { label: "Billing", href: routes.portalBilling, icon: CreditCard },
  { label: "Activity", href: routes.portalActivity, icon: ShieldCheck },
];

export function PortalLayout() {
  const { business, signOut, user } = usePortalSession();
